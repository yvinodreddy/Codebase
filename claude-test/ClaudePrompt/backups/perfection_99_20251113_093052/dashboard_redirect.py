#!/usr/bin/env python3
"""
Redirect from port 8888 to enhanced dashboard on 8889
"""
...
<html>
<head>
    <title>Redirecting to Enhanced Dashboard</title>
...
<body>
    <div class="container">
        <h1>🔥 Redirecting to Real-Time Dashboard</h1>
        <p>The NEW real-time dashboard with live cpp process tracking is on:</p>
...
if __name__ == "__main__":
    print("\n" + "="*80)
    print("🔀 DASHBOARD REDIRECT SERVER")
    print("="*80)
    print("\nRedirecting http://localhost:8888 → http://localhost:8890 (Real-Time Dashboard)")
