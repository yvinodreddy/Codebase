...
**What it does:**
- Works from ANY directory (not just ClaudePrompt)
...
```bash
cd /tmp
python3 /home/user01/claude-test/ClaudePrompt/portable_orchestrator.py --help
```

✅ **ULTRATHINK directives display**
```bash
python3 /home/user01/claude-test/ClaudePrompt/ultrathink_cli.py --show-directives
```

✅ **Web-compatible prompt generation**
```bash
python3 /home/user01/claude-test/ClaudePrompt/ultrathink_cli.py "test" --mode web-compatible
```
