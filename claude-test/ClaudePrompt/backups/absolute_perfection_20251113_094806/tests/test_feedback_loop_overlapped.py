"""
Comprehensive test suite for feedback_loop_overlapped
...
def module_under_test():
    ...
    module_path = project_root / "agent_framework/feedback_loop_overlapped.py"
    if not module_path.exists():
        pytest.skip(f"Module not found: agent_framework/feedback_loop_overlapped.py")

    try:
        spec = importlib.util.spec_from_file_location("feedback_loop_overlapped", module_path)
