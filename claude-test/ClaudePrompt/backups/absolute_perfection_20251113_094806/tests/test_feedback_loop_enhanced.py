"""
Comprehensive test suite for feedback_loop_enhanced
...
def module_under_test():
    ...
    module_path = project_root / "agent_framework/feedback_loop_enhanced.py"
    if not module_path.exists():
        pytest.skip(f"Module not found: agent_framework/feedback_loop_enhanced.py")

    try:
        spec = importlib.util.spec_from_file_location("feedback_loop_enhanced", module_path)
