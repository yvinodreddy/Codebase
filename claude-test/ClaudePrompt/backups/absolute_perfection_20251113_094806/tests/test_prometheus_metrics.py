"""
Comprehensive test suite for prometheus_metrics
...
def module_under_test():
    ...
    module_path = project_root / "monitoring/prometheus_metrics.py"
    if not module_path.exists():
        pytest.skip(f"Module not found: monitoring/prometheus_metrics.py")

    try:
        spec = importlib.util.spec_from_file_location("prometheus_metrics", module_path)
