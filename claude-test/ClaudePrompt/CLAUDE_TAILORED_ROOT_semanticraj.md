...
- ✅ /home/semanticraj/claude-test/CLAUDE.md (this file) - Global rules
- ✅ /home/semanticraj/claude-test/ClaudePrompt/CLAUDE.md - ULTRATHINK project rules
...
```bash
cd /home/semanticraj/claude-test/TestPrompt
