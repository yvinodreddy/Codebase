...
try:
    ...
    spec = importlib.util.spec_from_file_location("mcp_integration", "agent_framework/mcp_integration.py")
...
def test_module_has_attributes():
    ...
    assert len(dir(mcp_integration)) > 0, "Module should have attributes"
...
def test_module_file_exists():
    ...
    source_path = Path(__file__).parent.parent.parent / "agent_framework/mcp_integration.py"
