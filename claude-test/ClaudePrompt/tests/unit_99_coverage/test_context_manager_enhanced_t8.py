...
try:
    ...
    spec = importlib.util.spec_from_file_location("context_manager_enhanced", "agent_framework/context_manager_enhanced.py")
    if spec and spec.loader:
        context_manager_enhanced = importlib.util.module_from_spec(spec)
        spec.loader.exec_module(context_manager_enhanced)
...
def test_module_has_attributes():
    ...
    assert len(dir(context_manager_enhanced)) > 0, "Module should have attributes"
...
def test_module_file_exists():
    ...
    source_path = Path(__file__).parent.parent.parent / "agent_framework/context_manager_enhanced.py"
