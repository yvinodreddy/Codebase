...
try:
    ...
    spec = importlib.util.spec_from_file_location("performance_monitor", "infrastructure/performance_monitor.py")
...
def test_module_has_attributes():
    ...
    assert len(dir(performance_monitor)) > 0, "Module should have attributes"
...
def test_module_file_exists():
    ...
    source_path = Path(__file__).parent.parent.parent / "infrastructure/performance_monitor.py"
