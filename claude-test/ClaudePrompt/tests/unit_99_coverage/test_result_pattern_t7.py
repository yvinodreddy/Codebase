...
try:
    ...
    spec = importlib.util.spec_from_file_location("result_pattern", "result_pattern.py")
    if spec and spec.loader:
        result_pattern = importlib.util.module_from_spec(spec)
        spec.loader.exec_module(result_pattern)
...
def test_module_has_attributes():
    ...
    assert len(dir(result_pattern)) > 0, "Module should have attributes"
...
def test_module_file_exists():
    ...
    source_path = Path(__file__).parent.parent.parent / "result_pattern.py"
