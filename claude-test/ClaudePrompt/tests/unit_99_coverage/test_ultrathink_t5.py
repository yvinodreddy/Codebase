...
try:
    ...
    spec = importlib.util.spec_from_file_location("ultrathink", "ultrathink.py")
    if spec and spec.loader:
        ultrathink = importlib.util.module_from_spec(spec)
        spec.loader.exec_module(ultrathink)
...
def test_module_has_attributes():
    ...
    assert len(dir(ultrathink)) > 0, "Module should have attributes"
...
def test_module_file_exists():
    ...
    source_path = Path(__file__).parent.parent.parent / "ultrathink.py"
