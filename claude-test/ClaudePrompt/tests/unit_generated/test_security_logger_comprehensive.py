...
class TestStandaloneFunctions:
    ...
    def test_log_security_event_basic(self):
        ...
        try:
            with patch('security_logger.log_security_event') as mock_func:
                mock_func("event_type_value", "details_value", "severity_value")
                mock_func.assert_called_once_with("event_type_value", "details_value", "severity_value")
