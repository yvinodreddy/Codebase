...
def test_module_has_expected_attributes():
    ...
    public_attrs = [attr for attr in dir(dashboard_server) if not attr.startswith('_')]
...
def test_all_functions_are_callable():
    ...
    members = inspect.getmembers(dashboard_server)
...
def test_all_classes_are_defined():
    ...
    for class_name in classes:
        cls = getattr(dashboard_server, class_name)
...
def test_module_docstring_exists():
    ...
    assert dashboard_server.__doc__ is not None or dashboard_server.__file__ is not None
