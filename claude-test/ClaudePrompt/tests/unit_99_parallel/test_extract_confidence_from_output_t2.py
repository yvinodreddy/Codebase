...
def test_all_functions_are_callable():
    ...
    members = inspect.getmembers(extract_confidence_from_output)
...
def test_all_classes_are_defined():
    ...
    for class_name in classes:
        cls = getattr(extract_confidence_from_output, class_name)
...
def test_module_docstring_exists():
    ...
    assert extract_confidence_from_output.__doc__ is not None or extract_confidence_from_output.__file__ is not None
