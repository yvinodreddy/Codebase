...
def test_module_has_expected_attributes():
    ...
    public_attrs = [attr for attr in dir(fix_all_with_statements) if not attr.startswith('_')]
...
def test_all_functions_are_callable():
    ...
    members = inspect.getmembers(fix_all_with_statements)
...
def test_all_classes_are_defined():
    ...
    for class_name in classes:
        cls = getattr(fix_all_with_statements, class_name)
...
def test_module_docstring_exists():
    ...
    assert fix_all_with_statements.__doc__ is not None or fix_all_with_statements.__file__ is not None
