...
def test_module_has_expected_attributes():
    ...
    public_attrs = [attr for attr in dir(fix_all_test_syntax_errors) if not attr.startswith('_')]
...
def test_all_functions_are_callable():
    ...
    members = inspect.getmembers(fix_all_test_syntax_errors)
...
def test_all_classes_are_defined():
    ...
    for class_name in classes:
        cls = getattr(fix_all_test_syntax_errors, class_name)
...
def test_module_docstring_exists():
    ...
    assert fix_all_test_syntax_errors.__doc__ is not None or fix_all_test_syntax_errors.__file__ is not None
