...
def test_module_has_expected_attributes():
    ...
    public_attrs = [attr for attr in dir(setup_database) if not attr.startswith('_')]
...
def test_all_classes_are_defined():
    ...
    for class_name in classes:
        cls = getattr(setup_database, class_name)
...
def test_module_docstring_exists():
    ...
    assert setup_database.__doc__ is not None or setup_database.__file__ is not None
