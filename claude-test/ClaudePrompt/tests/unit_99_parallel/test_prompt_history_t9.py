...
def test_module_has_expected_attributes():
    ...
    public_attrs = [attr for attr in dir(prompt_history) if not attr.startswith('_')]
...
def test_all_classes_are_defined():
    ...
    for class_name in classes:
        cls = getattr(prompt_history, class_name)
...
def test_module_docstring_exists():
    ...
    assert prompt_history.__doc__ is not None or prompt_history.__file__ is not None
