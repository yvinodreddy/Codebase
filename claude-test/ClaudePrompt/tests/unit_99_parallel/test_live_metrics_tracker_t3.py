...
def test_module_has_expected_attributes():
    ...
    assert hasattr(live_metrics_tracker, '__name__')
...
def test_all_classes_are_defined():
    ...
    for class_name in classes:
        cls = getattr(live_metrics_tracker, class_name)
...
def test_module_docstring_exists():
    ...
    assert live_metrics_tracker.__doc__ is not None or live_metrics_tracker.__file__ is not None
