...
def test_module_has_expected_attributes():
    ...
    assert hasattr(claude_integration, '__name__')

    # Get all public attributes (not starting with _)
    public_attrs = [attr for attr in dir(claude_integration) if not attr.startswith('_')]
...
def test_all_classes_are_defined():
    ...
    for class_name in classes:
        cls = getattr(claude_integration, class_name)
...
def test_module_docstring_exists():
    ...
    assert claude_integration.__doc__ is not None or claude_integration.__file__ is not None
