...
def test_module_has_expected_attributes():
    ...
    public_attrs = [attr for attr in dir(realtime_db_updates) if not attr.startswith('_')]
...
def test_all_classes_are_defined():
    ...
    for class_name in classes:
        cls = getattr(realtime_db_updates, class_name)
...
def test_module_docstring_exists():
    ...
    assert realtime_db_updates.__doc__ is not None or realtime_db_updates.__file__ is not None
