...
def test_module_has_expected_attributes():
    ...
    public_attrs = [attr for attr in dir(stage_progress_tracker) if not attr.startswith('_')]
...
def test_all_classes_are_defined():
    ...
    for class_name in classes:
        cls = getattr(stage_progress_tracker, class_name)
...
def test_module_docstring_exists():
    ...
    assert stage_progress_tracker.__doc__ is not None or stage_progress_tracker.__file__ is not None
