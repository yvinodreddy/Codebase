...
def test_module_has_expected_attributes():
    ...
    public_attrs = [attr for attr in dir(prompt_preprocessor) if not attr.startswith('_')]
...
def test_all_classes_are_defined():
    ...
    for class_name in classes:
        cls = getattr(prompt_preprocessor, class_name)
...
def test_module_docstring_exists():
    ...
    assert prompt_preprocessor.__doc__ is not None or prompt_preprocessor.__file__ is not None
