...
def test_module_has_expected_attributes():
    ...
    public_attrs = [attr for attr in dir(enhanced_websocket_broadcast) if not attr.startswith('_')]
...
def test_all_functions_are_callable():
    ...
    members = inspect.getmembers(enhanced_websocket_broadcast)
...
def test_all_classes_are_defined():
    ...
    for class_name in classes:
        cls = getattr(enhanced_websocket_broadcast, class_name)
...
def test_module_docstring_exists():
    ...
    assert enhanced_websocket_broadcast.__doc__ is not None or enhanced_websocket_broadcast.__file__ is not None
