...
def test_module_has_expected_attributes():
    ...
    assert hasattr(convert_to_pdf, '__name__')
...
def test_all_classes_are_defined():
    ...
    for class_name in classes:
        cls = getattr(convert_to_pdf, class_name)
...
def test_module_docstring_exists():
    ...
    assert convert_to_pdf.__doc__ is not None or convert_to_pdf.__file__ is not None
