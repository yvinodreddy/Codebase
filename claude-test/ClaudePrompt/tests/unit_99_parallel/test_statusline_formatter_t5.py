...
def test_module_has_expected_attributes():
    ...
    public_attrs = [attr for attr in dir(statusline_formatter) if not attr.startswith('_')]
...
def test_all_classes_are_defined():
    ...
    for class_name in classes:
        cls = getattr(statusline_formatter, class_name)
...
def test_module_docstring_exists():
    ...
    assert statusline_formatter.__doc__ is not None or statusline_formatter.__file__ is not None
