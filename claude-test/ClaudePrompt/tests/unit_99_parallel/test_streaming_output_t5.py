...
def test_module_has_expected_attributes():
    ...
    public_attrs = [attr for attr in dir(streaming_output) if not attr.startswith('_')]
...
def test_all_classes_are_defined():
    ...
    for class_name in classes:
        cls = getattr(streaming_output, class_name)
...
def test_module_docstring_exists():
    ...
    assert streaming_output.__doc__ is not None or streaming_output.__file__ is not None
