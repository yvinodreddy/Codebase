...
def test_module_has_expected_attributes():
    ...
    assert hasattr(metrics_aggregator, '__name__')
...
def test_all_classes_are_defined():
    ...
    for class_name in classes:
        cls = getattr(metrics_aggregator, class_name)
...
def test_module_docstring_exists():
    ...
    assert metrics_aggregator.__doc__ is not None or metrics_aggregator.__file__ is not None
