"""
Comprehensive test suite for response_cache
...
def module_under_test():
    ...
    module_path = project_root / "infrastructure/response_cache.py"
    if not module_path.exists():
        pytest.skip(f"Module not found: infrastructure/response_cache.py")

    try:
        spec = importlib.util.spec_from_file_location("response_cache", module_path)
