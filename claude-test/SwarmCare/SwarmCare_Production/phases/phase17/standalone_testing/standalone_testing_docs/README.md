# Phase 17: Compliance - Standalone Testing Documentation
...
- **Testing UI:** Browser-based interactive testing at port 8017
...
- **Health Check:** http://localhost:8017/api/health
...
```bash
cp deployment/generated_files/* ../../../integration/phase17/
```
...
4. **Access UI** - Open http://localhost:8017
