# Quick Reference - Phase 17: Compliance

**Port:** 8017 | **Updated:** 2025-11-08
...
| **Health** | http://localhost:8017/api/health |
| **OpenAPI** | http://localhost:8017/openapi.json |
...
3. **Open Browser** → http://localhost:8017
