# Quick Reference - Phase 16: Reporting

**Port:** 8016 | **Updated:** 2025-11-08
...
| Endpoint | URL |
|----------|-----|
| **UI** | http://localhost:8016 |
| **API Docs** | http://localhost:8016/docs |
| **Health** | http://localhost:8016/api/health |
| **OpenAPI** | http://localhost:8016/openapi.json |
...
3. **Open Browser** → http://localhost:8016
