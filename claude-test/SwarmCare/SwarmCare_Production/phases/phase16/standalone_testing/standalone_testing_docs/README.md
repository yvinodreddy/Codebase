# Phase 16: Reporting - Standalone Testing Documentation
...
- **Testing UI:** Browser-based interactive testing at port 8016
...
- **Health Check:** http://localhost:8016/api/health
...
```bash
cp deployment/generated_files/* ../../../integration/phase16/
```
...
4. **Access UI** - Open http://localhost:8016
