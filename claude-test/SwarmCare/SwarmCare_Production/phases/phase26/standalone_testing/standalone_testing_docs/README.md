# Phase 26: Testing - Standalone Testing Documentation
...
- **Testing UI:** Browser-based interactive testing at port 8026
...
- **Health Check:** http://localhost:8026/api/health
...
```bash
cp deployment/generated_files/* ../../../integration/phase26/
```
...
4. **Access UI** - Open http://localhost:8026
