# Phase 02: NLP Processing - Standalone Testing Documentation
...
- **Testing UI:** Browser-based interactive testing at port 8002
...
```bash
cp deployment/generated_files/* ../../../integration/phase02/
```
...
4. **Access UI** - Open http://localhost:8002
...
**Phase 02 - NLP Processing Testing**
