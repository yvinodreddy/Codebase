# Phase 15: Analytics - Standalone Testing Documentation
...
- **Testing UI:** Browser-based interactive testing at port 8015
...
- **Health Check:** http://localhost:8015/api/health
...
```bash
cp deployment/generated_files/* ../../../integration/phase15/
```
...
4. **Access UI** - Open http://localhost:8015
