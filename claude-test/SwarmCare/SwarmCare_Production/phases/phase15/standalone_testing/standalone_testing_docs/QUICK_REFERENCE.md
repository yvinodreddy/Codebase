# Quick Reference - Phase 15: Analytics

**Port:** 8015 | **Updated:** 2025-11-08
...
| **Health** | http://localhost:8015/api/health |
| **OpenAPI** | http://localhost:8015/openapi.json |
...
3. **Open Browser** → http://localhost:8015
