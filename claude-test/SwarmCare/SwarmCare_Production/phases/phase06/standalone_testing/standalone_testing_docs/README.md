# Phase 06: Ontology Integration - Standalone Testing Documentation
...
- **Testing UI:** Browser-based interactive testing at port 8006
...
```bash
cp deployment/generated_files/* ../../../integration/phase06/
```
...
4. **Access UI** - Open http://localhost:8006
...
**Phase 06 - Ontology Integration Testing**
