# Quick Reference - Phase 19: Audit Trail

**Port:** 8019 | **Updated:** 2025-11-08
...
| **Health** | http://localhost:8019/api/health |
| **OpenAPI** | http://localhost:8019/openapi.json |
...
3. **Open Browser** → http://localhost:8019
