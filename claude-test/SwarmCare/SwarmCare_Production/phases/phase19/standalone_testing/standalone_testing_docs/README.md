# Phase 19: Audit Trail - Standalone Testing Documentation
...
- **Testing UI:** Browser-based interactive testing at port 8019
...
- **Health Check:** http://localhost:8019/api/health
...
```bash
cp deployment/generated_files/* ../../../integration/phase19/
```
...
4. **Access UI** - Open http://localhost:8019
