# Phase 10: Decision Support - Standalone Testing Documentation
...
- **Testing UI:** Browser-based interactive testing at port 8010
...
```bash
cp deployment/generated_files/* ../../../integration/phase10/
```
...
4. **Access UI** - Open http://localhost:8010
...
**Phase 10 - Decision Support Testing**
