# Testing Guide - Phase 00: Foundation
...
**Expected Output:**
```
🚀 Starting Phase 00: Foundation Testing
...
# Get results
curl http://localhost:8000/api/test/results | python3 -m json.tool
```
...
# Reseed data
curl -X POST http://localhost:8000/api/data/seed
```
...
curl http://localhost:8000/api/test/report > test_report.json
