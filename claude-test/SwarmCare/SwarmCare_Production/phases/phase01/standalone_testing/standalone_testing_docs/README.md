# Phase 01: Data Ingestion - Standalone Testing Documentation
...
- **Testing UI:** Browser-based interactive testing at port 8001
...
```bash
cp deployment/generated_files/* ../../../integration/phase01/
```
...
4. **Access UI** - Open http://localhost:8001
...
**Phase 01 - Data Ingestion Testing**
