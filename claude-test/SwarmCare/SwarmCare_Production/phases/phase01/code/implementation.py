...
class Phase01Implementation:
    ...
    def __init__(self):
        self.phase_id = 1
        self.phase_name = "RAG Heat System"
        self.story_points = 60
        self.priority = "P0"
        self.description = "Document ingestion, NLP, query pipeline, knowledge graph"
...
if __name__ == "__main__":
    ...
    task = {"goal": f"Implement {impl.phase_name}", "phase_id": 1}
