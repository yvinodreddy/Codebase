# Quick Reference - Phase 22: Scalability

**Port:** 8022 | **Updated:** 2025-11-08
...
| **Health** | http://localhost:8022/api/health |
| **OpenAPI** | http://localhost:8022/openapi.json |
...
3. **Open Browser** → http://localhost:8022
