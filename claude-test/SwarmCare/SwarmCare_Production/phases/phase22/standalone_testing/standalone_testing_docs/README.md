# Phase 22: Scalability - Standalone Testing Documentation
...
- **Testing UI:** Browser-based interactive testing at port 8022
...
- **Health Check:** http://localhost:8022/api/health
...
```bash
cp deployment/generated_files/* ../../../integration/phase22/
```
...
4. **Access UI** - Open http://localhost:8022
