# Quick Reference - Phase 23: API Gateway

**Port:** 8023 | **Updated:** 2025-11-08
...
| Endpoint | URL |
|----------|-----|
| **UI** | http://localhost:8023 |
| **API Docs** | http://localhost:8023/docs |
| **Health** | http://localhost:8023/api/health |
| **OpenAPI** | http://localhost:8023/openapi.json |
...
3. **Open Browser** → http://localhost:8023
