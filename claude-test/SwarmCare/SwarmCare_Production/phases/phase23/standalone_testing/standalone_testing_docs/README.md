# Phase 23: API Gateway - Standalone Testing Documentation
...
- **Testing UI:** Browser-based interactive testing at port 8023
...
- **Health Check:** http://localhost:8023/api/health
...
```bash
cp deployment/generated_files/* ../../../integration/phase23/
```
...
4. **Access UI** - Open http://localhost:8023
