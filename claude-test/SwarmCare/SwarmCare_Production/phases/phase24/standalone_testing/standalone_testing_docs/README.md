# Phase 24: Integration Hub - Standalone Testing Documentation
...
- **Testing UI:** Browser-based interactive testing at port 8024
...
```bash
cp deployment/generated_files/* ../../../integration/phase24/
```
...
4. **Access UI** - Open http://localhost:8024
...
**Phase 24 - Integration Hub Testing**
