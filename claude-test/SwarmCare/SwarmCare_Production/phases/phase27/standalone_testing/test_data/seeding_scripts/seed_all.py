#!/usr/bin/env python3
"""
Test Data Seeding Script for Phase 27: Full Trial Lifecycle (EDC, eConsent, AE)
...
print("=" * 80)
print("PHASE 27: FULL TRIAL LIFECYCLE (EDC, ECONSENT, AE) - DATA SEEDING")
print("=" * 80)
print()
...
if not seed_file.exists():
    ...
    default_seed = {
        "phase": "27",
        "phase_name": "Full Trial Lifecycle (EDC, eConsent, AE)",
    ...
    try:
        ...
        with driver.session() as session:
            ...
            result = session.run("""
                ...
                RETURN p
            """, phase_num="27", phase_name="Full Trial Lifecycle (EDC, eConsent, AE)")
            ...
            for i in range(10):
                ...
                """, phase="27", record_id=f"TEST-27-{i:03d}")

            print(f"   ✅ Created 10 test data records")

        driver.close()
        print("✅ Phase 27 test data seeded successfully in Neo4j")
...
if REDIS_AVAILABLE:
    ...
    try:
        ...
        r.set(f"phase:27:name", "Full Trial Lifecycle (EDC, eConsent, AE)")
        r.set(f"phase:27:seeded_at", datetime.now().isoformat())
        r.set(f"phase:27:record_count", "10")

        # Cache test data
        for i in range(10):
            r.set(f"phase:27:test:{i}", json.dumps({
                "id": f"TEST-27-{i:03d}",
...
print()
print("=" * 80)
print("✅ SEEDING COMPLETE FOR PHASE 27")
print("=" * 80)
