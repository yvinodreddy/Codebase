#!/bin/bash
# Phase 27 - Standalone Testing Application Startup Script
# This script starts the complete testing application with all services

echo "========================================"
echo "Phase 27: Full Trial Lifecycle (EDC, eConsent, AE)"
...
# Start application
echo "Starting FastAPI application on port 8027..."
python3 app.py
