# Phase 27: Deployment - Standalone Testing Documentation
...
- **Testing UI:** Browser-based interactive testing at port 8027
...
- **Health Check:** http://localhost:8027/api/health
...
```bash
cp deployment/generated_files/* ../../../integration/phase27/
```
...
4. **Access UI** - Open http://localhost:8027
