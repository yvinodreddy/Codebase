# Quick Reference - Phase 27: Deployment

**Port:** 8027 | **Updated:** 2025-11-08
...
| Endpoint | URL |
|----------|-----|
| **UI** | http://localhost:8027 |
| **API Docs** | http://localhost:8027/docs |
| **Health** | http://localhost:8027/api/health |
| **OpenAPI** | http://localhost:8027/openapi.json |
...
3. **Open Browser** → http://localhost:8027
