# Phase 25: Data Migration - Standalone Testing Documentation
...
- **Testing UI:** Browser-based interactive testing at port 8025
...
```bash
cp deployment/generated_files/* ../../../integration/phase25/
```
...
4. **Access UI** - Open http://localhost:8025
...
**Phase 25 - Data Migration Testing**
