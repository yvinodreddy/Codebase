#!/usr/bin/env python3
"""
Test Data Seeding Script for Phase 18: Clinical Trial Matching
...
print("=" * 80)
print("PHASE 18: CLINICAL TRIAL MATCHING - DATA SEEDING")
print("=" * 80)
print()
...
if not seed_file.exists():
    ...
    default_seed = {
        "phase": "18",
        "phase_name": "Clinical Trial Matching",
    ...
    try:
        ...
        with driver.session() as session:
            ...
            result = session.run("""
                ...
                RETURN p
            """, phase_num="18", phase_name="Clinical Trial Matching")
            ...
            for i in range(10):
                ...
                """, phase="18", record_id=f"TEST-18-{i:03d}")

            print(f"   ✅ Created 10 test data records")

        driver.close()
        print("✅ Phase 18 test data seeded successfully in Neo4j")
...
if REDIS_AVAILABLE:
    ...
    try:
        ...
        r.set(f"phase:18:name", "Clinical Trial Matching")
        r.set(f"phase:18:seeded_at", datetime.now().isoformat())
        r.set(f"phase:18:record_count", "10")

        # Cache test data
        for i in range(10):
            r.set(f"phase:18:test:{i}", json.dumps({
                "id": f"TEST-18-{i:03d}",
...
print()
print("=" * 80)
print("✅ SEEDING COMPLETE FOR PHASE 18")
print("=" * 80)
