# Phase 18: Security - Standalone Testing Documentation
...
- **Testing UI:** Browser-based interactive testing at port 8018
...
- **Health Check:** http://localhost:8018/api/health
...
```bash
cp deployment/generated_files/* ../../../integration/phase18/
```
...
4. **Access UI** - Open http://localhost:8018
