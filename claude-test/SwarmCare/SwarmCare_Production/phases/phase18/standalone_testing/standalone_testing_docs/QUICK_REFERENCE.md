# Quick Reference - Phase 18: Security

**Port:** 8018 | **Updated:** 2025-11-08
...
| **Health** | http://localhost:8018/api/health |
| **OpenAPI** | http://localhost:8018/openapi.json |
...
3. **Open Browser** → http://localhost:8018
