# Phase 04: Relationship Mapping - Standalone Testing Documentation
...
- **Testing UI:** Browser-based interactive testing at port 8004
...
```bash
cp deployment/generated_files/* ../../../integration/phase04/
```
...
4. **Access UI** - Open http://localhost:8004
...
**Phase 04 - Relationship Mapping Testing**
