# Phase 14: Patient Engagement - Standalone Testing Documentation
...
- **Testing UI:** Browser-based interactive testing at port 8014
...
- **Health Check:** http://localhost:8014/api/health
...
```bash
cp deployment/generated_files/* ../../../integration/phase14/
```
...
4. **Access UI** - Open http://localhost:8014
...
**Phase 14 - Patient Engagement Testing**
