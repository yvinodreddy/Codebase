# Quick Reference - Phase 14: Patient Engagement

**Port:** 8014 | **Updated:** 2025-11-08
...
| **Health** | http://localhost:8014/api/health |
| **OpenAPI** | http://localhost:8014/openapi.json |
...
3. **Open Browser** → http://localhost:8014
