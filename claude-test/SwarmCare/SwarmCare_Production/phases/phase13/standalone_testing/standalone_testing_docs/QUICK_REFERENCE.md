# Quick Reference - Phase 13: Care Coordination

**Port:** 8013 | **Updated:** 2025-11-08
...
| **Health** | http://localhost:8013/api/health |
| **OpenAPI** | http://localhost:8013/openapi.json |
...
3. **Open Browser** → http://localhost:8013
