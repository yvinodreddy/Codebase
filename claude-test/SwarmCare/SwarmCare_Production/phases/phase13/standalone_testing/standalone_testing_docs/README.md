# Phase 13: Care Coordination - Standalone Testing Documentation
...
- **Testing UI:** Browser-based interactive testing at port 8013
...
- **Health Check:** http://localhost:8013/api/health
...
```bash
cp deployment/generated_files/* ../../../integration/phase13/
```
...
4. **Access UI** - Open http://localhost:8013
...
**Phase 13 - Care Coordination Testing**
