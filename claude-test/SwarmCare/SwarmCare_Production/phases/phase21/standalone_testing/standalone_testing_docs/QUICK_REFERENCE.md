# Quick Reference - Phase 21: Performance

**Port:** 8021 | **Updated:** 2025-11-08
...
| Endpoint | URL |
|----------|-----|
| **UI** | http://localhost:8021 |
| **API Docs** | http://localhost:8021/docs |
| **Health** | http://localhost:8021/api/health |
| **OpenAPI** | http://localhost:8021/openapi.json |
...
3. **Open Browser** → http://localhost:8021
