# Phase 21: Performance - Standalone Testing Documentation
...
- **Testing UI:** Browser-based interactive testing at port 8021
...
```bash
cp deployment/generated_files/* ../../../integration/phase21/
```
...
4. **Access UI** - Open http://localhost:8021
