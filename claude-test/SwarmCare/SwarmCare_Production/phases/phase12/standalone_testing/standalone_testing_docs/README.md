# Phase 12: Risk Stratification - Standalone Testing Documentation
...
- **Testing UI:** Browser-based interactive testing at port 8012
...
- **Health Check:** http://localhost:8012/api/health
...
```bash
cp deployment/generated_files/* ../../../integration/phase12/
```
...
4. **Access UI** - Open http://localhost:8012
...
**Phase 12 - Risk Stratification Testing**
