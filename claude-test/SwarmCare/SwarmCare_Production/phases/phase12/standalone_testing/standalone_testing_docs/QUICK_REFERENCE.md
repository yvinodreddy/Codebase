# Quick Reference - Phase 12: Risk Stratification

**Port:** 8012 | **Updated:** 2025-11-08
...
| **OpenAPI** | http://localhost:8012/openapi.json |
...
3. **Open Browser** → http://localhost:8012
