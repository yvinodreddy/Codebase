# Phase 08: EHR Connectivity - Standalone Testing Documentation
...
- **Testing UI:** Browser-based interactive testing at port 8008
...
```bash
cp deployment/generated_files/* ../../../integration/phase08/
```
...
4. **Access UI** - Open http://localhost:8008
...
**Phase 08 - EHR Connectivity Testing**
