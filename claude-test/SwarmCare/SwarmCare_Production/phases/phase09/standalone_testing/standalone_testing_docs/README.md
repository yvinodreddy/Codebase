# Phase 09: Clinical Workflows - Standalone Testing Documentation
...
- **Testing UI:** Browser-based interactive testing at port 8009
...
- **Health Check:** http://localhost:8009/api/health
...
```bash
cp deployment/generated_files/* ../../../integration/phase09/
```
...
4. **Access UI** - Open http://localhost:8009
...
**Phase 09 - Clinical Workflows Testing**
