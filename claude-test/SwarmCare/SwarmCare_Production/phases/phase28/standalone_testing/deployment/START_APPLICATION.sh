#!/bin/bash
# Phase 28 - Standalone Testing Application Startup Script
# This script starts the complete testing application with all services

echo "========================================"
echo "Phase 28: Ultra-fast Offline Voice AI (<500ms, 11 EHRs - 100% Market Coverage)"
...
# Start application
echo "Starting FastAPI application on port 8028..."
python3 app.py
