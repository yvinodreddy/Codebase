# Quick Reference - Phase 28: Documentation

**Port:** 8028 | **Updated:** 2025-11-08
...
| **Health** | http://localhost:8028/api/health |
| **OpenAPI** | http://localhost:8028/openapi.json |
...
3. **Open Browser** → http://localhost:8028
