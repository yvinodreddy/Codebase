# Phase 28: Documentation - Standalone Testing Documentation
...
- **Testing UI:** Browser-based interactive testing at port 8028
...
- **Health Check:** http://localhost:8028/api/health
...
```bash
cp deployment/generated_files/* ../../../integration/phase28/
```
...
4. **Access UI** - Open http://localhost:8028
...
**Phase 28 - Documentation Testing**
