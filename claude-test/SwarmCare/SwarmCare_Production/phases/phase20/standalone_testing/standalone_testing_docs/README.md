# Phase 20: Monitoring - Standalone Testing Documentation
...
- **Testing UI:** Browser-based interactive testing at port 8020
...
```bash
cp deployment/generated_files/* ../../../integration/phase20/
```
...
4. **Access UI** - Open http://localhost:8020
