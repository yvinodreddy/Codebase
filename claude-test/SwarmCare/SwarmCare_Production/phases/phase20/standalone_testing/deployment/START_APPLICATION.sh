#!/bin/bash
# Phase 20 - Standalone Testing Application Startup Script
# This script starts the complete testing application with all services

echo "========================================"
echo "Phase 20: Security Certifications (SOC 2, HITRUST)"
...
# Start application
echo "Starting FastAPI application on port 8020..."
python3 app.py
