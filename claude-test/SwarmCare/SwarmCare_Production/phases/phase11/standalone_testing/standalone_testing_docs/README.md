# Phase 11: Quality Metrics - Standalone Testing Documentation
...
- **Testing UI:** Browser-based interactive testing at port 8011
...
```bash
cp deployment/generated_files/* ../../../integration/phase11/
```
...
4. **Access UI** - Open http://localhost:8011
...
**Phase 11 - Quality Metrics Testing**
