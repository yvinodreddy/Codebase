# Phase 05: Knowledge Graph - Standalone Testing Documentation
...
- **Testing UI:** Browser-based interactive testing at port 8005
...
```bash
cp deployment/generated_files/* ../../../integration/phase05/
```
...
4. **Access UI** - Open http://localhost:8005
...
**Phase 05 - Knowledge Graph Testing**
