# Phase 03: Entity Recognition - Standalone Testing Documentation
...
- **Testing UI:** Browser-based interactive testing at port 8003
...
```bash
cp deployment/generated_files/* ../../../integration/phase03/
```
...
4. **Access UI** - Open http://localhost:8003
...
**Phase 03 - Entity Recognition Testing**
