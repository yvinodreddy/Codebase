-- ===============================================================================
-- FINAL CORRECTED INSERT SAMPLE SURVEY SCRIPT V3
-- ===============================================================================
-- 100% PRODUCTION READY - ALL COLUMN NAMES VERIFIED AGAINST ACTUAL SCHEMA
-- ===============================================================================
-- FIXED: Removed DTS, PROVIDER, EDITOR from LED_FFSANSWERS_MORE_V2 inserts
-- ===============================================================================

-- Insert a complete sample V2 survey for testing
-- CORRECTED: Fixed all column name mismatches including DTS issue
...
BEGIN
    ...
    -- CORRECTED COLUMN NAMES (V3):
    --   REMOVED: DTS, PROVIDER, EDITOR (these columns do NOT exist in this table!)
    --
    --   Actual columns in LED_FFSANSWERS_MORE_V2:
    --   SEQ          = Sequence number (1-4)
    --   MEMBERID     = Member ID
    --   SURVEYID     = Survey ID
    --   SURVEYTYPE   = Survey type ('FFS')
    ...
    INSERT INTO LED_FFSANSWERS_MORE_V2 (SEQ, MEMBERID, SURVEYID, SURVEYTYPE, QUESTIONID, TTYPE, BDATE, TDATE, TVALUE, NAME)
    VALUES (1, v_memberid, v_surveyid, 'FFS', 3, 'Venous Blood Test', NULL, NULL, '15 mcg/dL', NULL);

    INSERT INTO LED_FFSANSWERS_MORE_V2 (SEQ, MEMBERID, SURVEYID, SURVEYTYPE, QUESTIONID, TTYPE, BDATE, TDATE, TVALUE, NAME)
    VALUES (2, v_memberid, v_surveyid, 'FFS', 3, 'Capillary Test', NULL, NULL, '12 mcg/dL', NULL);

    INSERT INTO LED_FFSANSWERS_MORE_V2 (SEQ, MEMBERID, SURVEYID, SURVEYTYPE, QUESTIONID, TTYPE, BDATE, TDATE, TVALUE, NAME)
    VALUES (3, v_memberid, v_surveyid, 'FFS', 3, 'Follow-up Venous', NULL, NULL, '8 mcg/dL', NULL);

    INSERT INTO LED_FFSANSWERS_MORE_V2 (SEQ, MEMBERID, SURVEYID, SURVEYTYPE, QUESTIONID, TTYPE, BDATE, TDATE, TVALUE, NAME)
    VALUES (4, v_memberid, v_surveyid, 'FFS', 3, 'Final Confirmation', NULL, NULL, '5 mcg/dL', NULL);
    ...
    INSERT INTO LED_FFSANSWERS_MORE_V2 (SEQ, MEMBERID, SURVEYID, SURVEYTYPE, QUESTIONID, TTYPE, BDATE, TDATE, TVALUE, NAME)
    VALUES (1, v_memberid, v_surveyid, 'FFS', 5, 'Pediatrician', NULL, NULL, NULL, 'Dr. Sarah Johnson');

    INSERT INTO LED_FFSANSWERS_MORE_V2 (SEQ, MEMBERID, SURVEYID, SURVEYTYPE, QUESTIONID, TTYPE, BDATE, TDATE, TVALUE, NAME)
    VALUES (2, v_memberid, v_surveyid, 'FFS', 5, 'Environmental Inspector', NULL, NULL, NULL, 'Bob Martinez');
    ...
    DBMS_OUTPUT.PUT_LINE('  LED_FFSANSWERS_MORE_V2: SEQ, MEMBERID, SURVEYID, SURVEYTYPE, QUESTIONID, TTYPE, BDATE, TDATE, TVALUE, NAME');
    DBMS_OUTPUT.PUT_LINE('  LED_CHECKBOX_ANSWERS_V2: OPTION_VALUE, OPTION_SELECTED, OPTION_DATE');
    DBMS_OUTPUT.PUT_LINE('');
    DBMS_OUTPUT.PUT_LINE('CRITICAL FIX IN V3:');
    DBMS_OUTPUT.PUT_LINE('  - Removed DTS, PROVIDER, EDITOR from LED_FFSANSWERS_MORE_V2 inserts');
    DBMS_OUTPUT.PUT_LINE('  - These columns exist in LED_FFSANSWERS_V2 but NOT in LED_FFSANSWERS_MORE_V2');
    DBMS_OUTPUT.PUT_LINE('');
...
-- ===============================================================================
-- COLUMN MAPPING DOCUMENTATION - V3 CORRECTED
-- ===============================================================================

-- LED_FFSANSWERS_V2 actual columns (verified against DDL):
--   MEMBERID         NUMBER(12,0)
--   SURVEYID         NUMBER(12,0)
--   SURVEYTYPE       VARCHAR2(5)
--   PROVIDER         VARCHAR2(3)        -- EXISTS in V2
--   EDITOR           VARCHAR2(30)       -- EXISTS in V2
--   DTS              DATE                -- EXISTS in V2
...
--
--   CRITICAL: NO DTS, PROVIDER, EDITOR columns in this table!
...
-- ===============================================================================
-- CRITICAL DIFFERENCES BETWEEN LED_FFSANSWERS_V2 AND LED_FFSANSWERS_MORE_V2
-- ===============================================================================

-- Table: LED_FFSANSWERS_V2
--   Purpose: Simple question answers (Q1, Q2, Q4, Q6, Q7, Q8, Q9, Q11, Q13, Q14)
--   Columns: MEMBERID, SURVEYID, SURVEYTYPE, PROVIDER, EDITOR, DTS, QUESTIONID,
--            ANSWER1, ANSWER_TYPE, ANSWER_SEQUENCE
--   Key: HAS DTS, PROVIDER, EDITOR columns

-- Table: LED_FFSANSWERS_MORE_V2
--   Purpose: Multi-row answers (Q3 test results, Q5 individuals)
--   Columns: SEQ, MEMBERID, SURVEYID, SURVEYTYPE, QUESTIONID, TTYPE, BDATE,
--            TDATE, TVALUE, NAME
--   Key: NO DTS, PROVIDER, EDITOR columns

-- WHY THE DIFFERENCE:
-- LED_FFSANSWERS_V2 tracks who edited and when (DTS, EDITOR, PROVIDER)
-- LED_FFSANSWERS_MORE_V2 is a simple data table without audit fields

-- ===============================================================================
-- END OF CORRECTED INSERT SCRIPT V3
-- ===============================================================================
