...
ultrathinkc "your question" --api

# With verbose validation logs
ultrathinkc "your question" --api --verbose

# Large prompts (300-500 lines)
ultrathinkc --file large_prompt.txt --api
```
...
```bash
$ ultrathinkc "what is the capital of France" --api
...
```bash
$ ultrathinkc "explain quantum entanglement" --api --verbose
...
```bash
$ ultrathinkc --file healthcare_architecture.txt --api
...
**HOW TO USE**:
```bash
# Just use ultrathinkc - validation is automatic
ultrathinkc "your question" --api
```
