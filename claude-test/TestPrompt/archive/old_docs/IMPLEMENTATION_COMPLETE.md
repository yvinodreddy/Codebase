...
**Location**: `/home/user01/claude-test/TestPrompt/validate_my_response.py`
...
```
User asks via ultrathinkc: "what is 2+2"
  ↓
...
- Reopen Claude Code in /home/user01/claude-test/TestPrompt
- Claude Code reads CLAUDE.md → Validation protocol loaded ✅

# Test 2: System restart
- Restart computer
- Open Claude Code
- Navigate to /home/user01/claude-test/TestPrompt
- Claude Code reads CLAUDE.md → Validation protocol loaded ✅
...
```bash
# User runs
ultrathinkc "Explain quantum entanglement" --verbose
...
### For Users
```
No training needed! Just use ultrathinkc as before:
...
3. Check Claude Code is opening in /home/user01/claude-test/TestPrompt
...
ultrathinkc "test question" --verbose
