"""
Comprehensive test suite for realtime_log_monitor
...
def module_under_test():
    ...
    module_path = project_root / "realtime_log_monitor.py"
    if not module_path.exists():
        pytest.skip(f"Module not found: realtime_log_monitor.py")

    try:
        spec = importlib.util.spec_from_file_location("realtime_log_monitor", module_path)
