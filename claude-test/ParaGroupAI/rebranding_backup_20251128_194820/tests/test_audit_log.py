"""
Comprehensive test suite for audit_log
...
def module_under_test():
    ...
    module_path = project_root / "security/audit_log.py"
    if not module_path.exists():
        pytest.skip(f"Module not found: security/audit_log.py")

    try:
        spec = importlib.util.spec_from_file_location("audit_log", module_path)
