...
Module: monitoring/comprehensive_monitoring.py
...
def module_path():
    ...
    return project_root / "monitoring/comprehensive_monitoring.py"
...
def module_under_test(module_path):
    ...
    if not module_path.exists():
        pytest.skip(f"Module not found: monitoring/comprehensive_monitoring.py")

    try:
        spec = importlib.util.spec_from_file_location("comprehensive_monitoring", module_path)
        if spec is None or spec.loader is None:
            pytest.skip(f"Cannot create spec for module: monitoring/comprehensive_monitoring.py")

        module = importlib.util.module_from_spec(spec)
        sys.modules["comprehensive_monitoring"] = module
...
class TestModuleClasses:
    ...
    def test_classes_can_be_instantiated(self, module_under_test):
        ...
        public_classes = [(name, cls) for name, cls in classes
                         if not name.startswith('_') and cls.__module__ == "comprehensive_monitoring"]
