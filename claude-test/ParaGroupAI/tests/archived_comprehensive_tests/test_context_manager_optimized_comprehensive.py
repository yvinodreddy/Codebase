#!/usr/bin/env python3
"""
COMPREHENSIVE Tests for context_manager_optimized.py
...
try:
    ...
    from context_manager_optimized import *
except ImportError as e:
    pytest.skip(f"Cannot import context_manager_optimized: {e}", allow_module_level=True)
...
class TestModuleFunctions:
    ...
    def test_add_message_basic_execution(self):
        ...
        from context_manager_optimized import add_message
    ...
    def test_should_compact_basic_execution(self):
        ...
        from context_manager_optimized import should_compact
    ...
    def test_compact_basic_execution(self):
        ...
        from context_manager_optimized import compact
    ...
    def test_estimate_tokens_basic_execution(self):
        ...
        from context_manager_optimized import estimate_tokens
    ...
    def test_get_total_tokens_basic_execution(self):
        ...
        from context_manager_optimized import get_total_tokens
    ...
    def test_get_messages_basic_execution(self):
        ...
        from context_manager_optimized import get_messages
    ...
    def test_get_usage_percentage_basic_execution(self):
        ...
        from context_manager_optimized import get_usage_percentage
    ...
    def test_get_statistics_basic_execution(self):
        ...
        from context_manager_optimized import get_statistics
    ...
    def test_get_compaction_history_basic_execution(self):
        ...
        from context_manager_optimized import get_compaction_history
    ...
    def test_mark_important_basic_execution(self):
        ...
        from context_manager_optimized import mark_important
    ...
    def test_save_to_file_basic_execution(self):
        ...
        from context_manager_optimized import save_to_file
    ...
    def test_validate_cache_basic_execution(self):
        """Test validate_cache executes with valid inputs"""
        from context_manager_optimized import validate_cache
    ...
    def test_repair_cache_basic_execution(self):
        """Test repair_cache executes with valid inputs"""
        from context_manager_optimized import repair_cache
...
class TestOptimizedContextManager:
    """Comprehensive tests for OptimizedContextManager class"""
    
    def test_optimizedcontextmanager_instantiation(self):
        ...
        try:
            ...
            # Class requires constructor arguments
            pytest.skip(f"OptimizedContextManager requires constructor args: {e}")
    
    def test_optimizedcontextmanager_has_expected_methods(self):
        """Verify OptimizedContextManager has expected methods"""
        from context_manager_optimized import OptimizedContextManager
        
        expected_methods = ['add_message', 'should_compact', 'compact', 'estimate_tokens', 'get_total_tokens', 'get_messages', 'get_usage_percentage', 'get_statistics', 'get_compaction_history', 'mark_important', 'save_to_file', 'validate_cache', 'repair_cache']
        
        for method_name in expected_methods:
            assert hasattr(OptimizedContextManager, method_name), f"Missing method: {method_name}"
    

    def test_optimizedcontextmanager_add_message_execution(self):
    ...
    def test_optimizedcontextmanager_should_compact_execution(self):
    ...
    def test_optimizedcontextmanager_compact_execution(self):
    ...
    def test_optimizedcontextmanager_estimate_tokens_execution(self):
    ...
    def test_optimizedcontextmanager_get_total_tokens_execution(self):
    ...
    def test_optimizedcontextmanager_get_messages_execution(self):
    ...
    def test_optimizedcontextmanager_get_usage_percentage_execution(self):
    ...
    def test_optimizedcontextmanager_get_statistics_execution(self):
    ...
    def test_optimizedcontextmanager_get_compaction_history_execution(self):
    ...
    def test_optimizedcontextmanager_mark_important_execution(self):
    ...
    def test_optimizedcontextmanager_save_to_file_execution(self):
    ...
    def test_optimizedcontextmanager_validate_cache_execution(self):
    ...
    def test_optimizedcontextmanager_repair_cache_execution(self):
