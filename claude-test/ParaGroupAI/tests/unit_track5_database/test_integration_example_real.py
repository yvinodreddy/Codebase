#!/usr/bin/env python3
"""
REAL Tests for database/integration_example.py
...
try:
    from database.integration_example import *
except ImportError as e:
    pytest.skip(f"Cannot import database.integration_example: {e}", allow_module_level=True)
