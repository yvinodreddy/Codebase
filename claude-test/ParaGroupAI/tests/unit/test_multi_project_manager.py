#!/usr/bin/env python3
"""
Test suite for multi_project_manager.py
...
class TestMulti_project_manager:
    """Test suite for multi_project_manager module"""
...
if __name__ == "__main__":
    pytest.main([__file__, "-v", "--cov=multi_project_manager", "--cov-report=term-missing"])
