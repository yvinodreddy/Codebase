#!/usr/bin/env python3
"""
Test suite for result_pattern.py
...
class TestResult_pattern:
    """Test suite for result_pattern module"""
...
if __name__ == "__main__":
    pytest.main([__file__, "-v", "--cov=result_pattern", "--cov-report=term-missing"])
