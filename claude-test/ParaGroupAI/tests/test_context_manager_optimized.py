"""
Comprehensive test suite for context_manager_optimized
...
def module_under_test():
    ...
    module_path = project_root / "agent_framework/context_manager_optimized.py"
    if not module_path.exists():
        pytest.skip(f"Module not found: agent_framework/context_manager_optimized.py")

    try:
        spec = importlib.util.spec_from_file_location("context_manager_optimized", module_path)
