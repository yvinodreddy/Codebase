...
# INSTALLATION:
# Add to your ~/.bashrc:
#   source /home/user01/claude-test/ParaGroupAI/capture_context_helper.sh
#
...
capture_context() {
    ...
    if [[ -f "$cache_file" ]] && [[ -s "$cache_file" ]]; then
        ...
        python3 /home/user01/claude-test/ParaGroupAI/get_live_context_metrics.py --input "$cache_file" 2>/dev/null
    else
...
cpp_live() {
    ...
    # Run prsg command normally
    /home/user01/claude-test/ParaGroupAI/prsg "$prompt" $flags
}
...
update_statusline_config() {
    ...
    local statusline_script="/home/user01/claude-test/ParaGroupAI/statusline_with_live_metrics.sh"
