"""
Comprehensive test suite for streaming_output
...
def module_under_test():
    ...
    module_path = project_root / "streaming_output.py"
    if not module_path.exists():
        pytest.skip(f"Module not found: streaming_output.py")

    try:
        spec = importlib.util.spec_from_file_location("streaming_output", module_path)
