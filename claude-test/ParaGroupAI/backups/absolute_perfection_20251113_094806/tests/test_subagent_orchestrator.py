"""
Comprehensive test suite for subagent_orchestrator
...
def module_under_test():
    ...
    module_path = project_root / "agent_framework/subagent_orchestrator.py"
    if not module_path.exists():
        pytest.skip(f"Module not found: agent_framework/subagent_orchestrator.py")

    try:
        spec = importlib.util.spec_from_file_location("subagent_orchestrator", module_path)
